...
namespace OTTER
{
    ...
    public class Sprite
    {
        ...
        /// <summary>
        /// Provjerava hoće li lik dotaknuti nekog drugog lika prije nego što ga zapravo dotakne.
        /// </summary>
        /// <param name="b">Lik kojeg će možda dotaknuti.</param>
        /// <param name="smjer">"d" ako u desnom smjeru,"a" u lijevom smjeru</param>
        /// <returns>Vraća true/false.</returns>
        public bool WillTouchSprite(Sprite b, string smjer)
        {
            Sprite a = this;
        ...
        /// <param name="b">Lik kojeg će možda dotaknuti.</param>
        /// <returns>Vraća true/false.</returns>
        public bool WillTouchSprite(Sprite b)
        {
            Sprite a = this;
        ...
        //public bool TouchingSprite_ne(Sprite b, int offset)
        //{
        //    Sprite a = this;
        ...
        /// <param name="left">Indeks retka gdje su sličice za lijevi smjer</param>
        /// <param name="right">Indeks retka gdje su sličice za desni smjer</param>
        public void TrunkRun(int left, int right)
        {
            //ako nema slike, ignoriraj
            if (spriteTile == null)
                return;
            ...
            //ako je došao do kraja, vrati se na početak
            if (this.spriteTile.currentCol >= this.spriteTile.colsx-4)
            {
                this.spriteTile.currentCol = 0;
            }
        }
        ...
        /// <summary>
        /// Metoda za ne pomično stanje lika.
        /// </summary>
        /// <param name="rowLeft">U kojem stupcu se nalaze sličice za lijevu stranu</param>
        /// <param name="rowRight">U kojem stupcu se nalaze sličice za lijevu stranu</param>
        public void Idle(int rowLeft,int rowRight)
        {
            //ako nema slike, ignoriraj
            if (spriteTile == null)
                return;
            ...
            if (Direction == 90)
            {
                this.spriteTile.currentRow = rowRight;
            }
            else if (Direction == 270 || Direction == -90)
            {
                this.spriteTile.currentRow = rowLeft;
            }
            ...
            //ako je došao do kraja, vrati se na početak
            if (this.spriteTile.currentCol >= this.spriteTile.colsx-1)
            {
                this.spriteTile.currentCol = 0;
            }
        }
